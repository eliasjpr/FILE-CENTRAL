            ...
            JSON3.stringify = function (source, filter, width) {
              ...
              if (typeof filter == "function" || typeof filter == "object" && filter) {
                if ((className = getClass.call(filter)) == functionClass) {
                  ...
                  properties = {};
                  for (var index = 0, length = filter.length, value; index < length; value = filter[index++], (className = getClass.call(value), className==
              ...
              return serialize("", (value = {}, value[""] = source, value
              ),
